...
function buildPrompt(context) {
  ...
  return [
    ...
    '- Keep shell evidence minimal and focused: use targeted file globs and line ranges.',
    '- Do not dump full contents of non-code assets (svg/png/jpg/jpeg/webp/gif/ico/pdf).',
    '- For asset checks, inspect path/metadata only (e.g., rg --files, file, sips) instead of raw content.',
